    ...
    <script>
        $(document).ready(function() {
            $('form').submit(function(e) {
                ...
                if (conf) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'editProfil.php',
                        data: $('form').serialize(), //biar jadi json
                        success: function(response) {
                            // Assuming your 'editProfil.php' returns a success message
                            showSuccessAlert();
                            // You can redirect to the dashboard after a delay (e.g., 2 seconds)
                            setTimeout(function() {
            ...
            if (isset($_SESSION['update_success']) && $_SESSION['update_success']) {
                // echo '$(document).ready(function () { showSuccessAlert(); });';
